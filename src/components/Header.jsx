            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex items-center gap-4">
                        <button className="hidden md:block text-blue-700 font-semibold hover:text-blue-900 transition text-sm">Connexion</button>
                        <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-full font-semibold shadow-md transition text-sm">S'inscrire</button>
                    </div>
                </div>
            </div>
        </header>
